...
And plot it
```{r}
png(paste("../plots/","coicop_co2_classes_relative","_","upperclass", upper_threshold, ".png", sep=""))
...
```{r}
export_formattable(FT,paste("../plots/","summary","_","upperclass", upper_threshold, ".png", sep=""))
...
```{r}
leng = 512
png(paste("../plots/","totals_per_class","_","upperclass", upper_threshold, ".png", sep=""),height=leng,width=2*leng)
...
```{r}
export_formattable(FT,paste("../plots/","highlevel","_","upperclass", upper_threshold, ".png", sep=""))
```
...
```{r}
export_formattable(FT,paste("../plots/","housing","_","upperclass", upper_threshold, ".png", sep=""))
```
...
```{r}
export_formattable(FT,paste("../plots/","mobility","_","upperclass", upper_threshold, ".png", sep=""))
...
```{r}
export_formattable(FT,paste("../plots/","consumption","_","upperclass", upper_threshold, ".png", sep=""))
```
